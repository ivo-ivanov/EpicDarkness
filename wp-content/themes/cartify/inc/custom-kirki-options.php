...
Kirki::add_field( $config_theme_options, [
	...
	'description' => sprintf( wp_kses( __('You can get/create Client ID by following these steps <a href="%s" target="_blank">steps</a>', 'cartify'), array( 'a' => array( 'href' => array(), 'target' => array() ) ) ), esc_url( 'developers.google.com/identity/sign-in/web/sign-in' ) ),
	'section'  => $section_api_settings,
	'default'  => '',
	'priority' => 10,
] );
